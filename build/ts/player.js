...
(function (Shumway) {
    ...
    (function (_Player) {
        ...
        var Player = (function () {
            function Player(gfxService, env) {
            ...
            Player.prototype._enterEventLoop = function () {
                ...
                if (this._env === 'test') {
                    ...
                    flash.external.ExternalInterface._addCallback('__tick__', function (request, args) {
                        console.log('tick');
                        self._eventLoopTick();
                    }, false);
                    flash.external.ExternalInterface._addCallback('__takeScreenshot__', function (request, args) {
                    }, false);
                    this._eventLoopTick();
                    return;
                }
