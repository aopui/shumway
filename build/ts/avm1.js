        ...
        (function (Lib) {
            ...
            var AVM1MovieClip = (function (_super) {
                ...
                AVM1MovieClip.prototype.addFrameScript = function (frameIndex, actionsBlock) {
                    ...
                    var actionsData = this.context.actionsDataFactory.createActionsData(actionsBlock, 'f' + frameIndex + 'i' + scripts.length);
                ...
                AVM1MovieClip.prototype._addInitActionBlocks = function (frameIndex, actionsBlocks) {
                    ...
                    function listener(e) {
                        ...
                        for (var i = 0; i < actionsBlocks.length; i++) {
                            var actionsData = avm1Context.actionsDataFactory.createActionsData(actionsBlocks[i].actionsData, 'f' + frameIndex + 'i' + i);
